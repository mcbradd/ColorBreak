...
4. Push `main`; the Pages workflow runs the full check and both browser engines before publishing, retains screenshots in the `command-panel-browser-evidence` artifact for 14 days, then verifies the deployed bytes against the commit SHA.
